...
The project uses **GitHub Actions** to automatically sync game data from the buddy.farm API:

> **Note:** To enable automated syncs, you must configure the `GRAPHQL_API_ENDPOINT` secret in your GitHub repository settings (Settings → Secrets and variables → Actions → New repository secret).
