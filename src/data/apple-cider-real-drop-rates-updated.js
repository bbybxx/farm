...
export const APPLE_CIDER_REAL_DROP_RATES = {
  ...
  locations: {
    ...
    "Haunted House": {
      rq0cs0: {
        "Candy": { dropsPerCider: 212.85 },
        "Lollipop": { dropsPerCider: 77.40 },
        "Taffy": { dropsPerCider: 48.68 },
        "Apple": { dropsPerCider: 23.11 },
        "Jack-o-lantern": { dropsPerCider: 13.62 },
        "Candy Corn": { dropsPerCider: 13.61 },
        "Spider": { dropsPerCider: 3.82 },
        "Chattering Teeth": { dropsPerCider: 1.77 },
        "Bat Wing": { dropsPerCider: 1.77 },
        "Witch Hat": { dropsPerCider: 1.77 },
        "Treat Bag 03": { dropsPerCider: 0.53191 },
        "Treat Bag 02": { dropsPerCider: 0.52910 },
        "Treat Bag 01": { dropsPerCider: 0.52910 },
        "Hockey Mask": { dropsPerCider: 0.02679 }
      },
      rq0cs1: {
        "Candy": { dropsPerCider: 266.06 },
        "Lollipop": { dropsPerCider: 96.75 },
        "Taffy": { dropsPerCider: 60.85 },
        "Apple": { dropsPerCider: 28.88 },
        "Jack-o-lantern": { dropsPerCider: 17.02 },
        "Candy Corn": { dropsPerCider: 17.01 },
        "Spider": { dropsPerCider: 4.77 },
        "Chattering Teeth": { dropsPerCider: 2.21 },
        "Bat Wing": { dropsPerCider: 2.21 },
        "Witch Hat": { dropsPerCider: 2.21 },
        "Treat Bag 03": { dropsPerCider: 0.66225 },
        "Treat Bag 02": { dropsPerCider: 0.66225 },
        "Treat Bag 01": { dropsPerCider: 0.66225 },
        "Hockey Mask": { dropsPerCider: 0.03349 }
      },
      rq1cs0: {
        "Candy": { dropsPerCider: 192.09 },
        "Taffy": { dropsPerCider: 71.87 },
        "Lollipop": { dropsPerCider: 71.87 },
        "Apple": { dropsPerCider: 26.13 },
        "Candy Corn": { dropsPerCider: 12.72 },
        "Jack-o-lantern": { dropsPerCider: 12.71 },
        "Spider": { dropsPerCider: 4.47 },
        "Chattering Teeth": { dropsPerCider: 2.08 },
        "Witch Hat": { dropsPerCider: 2.08 },
        "Bat Wing": { dropsPerCider: 2.07 },
        "Treat Bag 02": { dropsPerCider: 0.62112 },
        "Treat Bag 03": { dropsPerCider: 0.62112 },
        "Treat Bag 01": { dropsPerCider: 0.62112 },
        "Hockey Mask": { dropsPerCider: 0.03031 }
      },
      rq1cs1: {
        "Candy": { dropsPerCider: 240.12 },
        "Taffy": { dropsPerCider: 89.84 },
        "Lollipop": { dropsPerCider: 89.84 },
        "Apple": { dropsPerCider: 32.67 },
        "Candy Corn": { dropsPerCider: 15.90 },
        "Jack-o-lantern": { dropsPerCider: 15.89 },
        "Spider": { dropsPerCider: 5.59 },
        "Chattering Teeth": { dropsPerCider: 2.60 },
        "Witch Hat": { dropsPerCider: 2.59 },
        "Bat Wing": { dropsPerCider: 2.59 },
        "Treat Bag 02": { dropsPerCider: 0.77519 },
        "Treat Bag 03": { dropsPerCider: 0.77519 },
        "Treat Bag 01": { dropsPerCider: 0.77519 },
        "Hockey Mask": { dropsPerCider: 0.03789 }
      }
    },
